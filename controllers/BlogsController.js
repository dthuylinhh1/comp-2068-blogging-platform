...
exports.index = async (req, res) =>{
    try{
        ...
        res.status(400).json({
            message: ' There was an error fetching the blogs', error
        });
    }
};
...
exports.show = async (req, res) =>{
    try {
        ...
        res.status(400).json({message:"There was an error editing this blog!"});
    }   
};
...
exports.create = async (req, res) => {
    ...
    try{
        ...
        res.status(400).json({
            message: "There was an error creating this blog post", error
        });
    }
